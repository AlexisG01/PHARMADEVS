...
public class VentasTest {
    ...
    @BeforeEach
    public void setUp(){
        ventas = new Ventas(1,new Date(),"Efectivo","100.385");
    }
    ...
    public void testVentasConstrunctorAndGetter(){
        assertAll("Validar datos ventas",
                ...
                () -> assertEquals("100.385",ventas.getTotalventa())
                );
    }
    ...
    public void testToString(){
        ...
        assertAll("Validar datos ventas",
                ...
                () -> assertTrue(str.contains("100.385"))
                );
    }
}
